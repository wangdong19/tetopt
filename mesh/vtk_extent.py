...
def vtk_cell_index(p, celltype):
    ...
    Notes
    -----
    Get the vertex numbering order of vtk cell relative to fealpy mesh cell, 
    which is used to convert the cell vertex numbering order in FEALPy to the 
    vtk numbering order    
    """
